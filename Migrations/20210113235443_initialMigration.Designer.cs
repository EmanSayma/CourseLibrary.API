...
namespace CourseLibrary.API.Migrations
{
    ...
    [Migration("20210113235443_initialMigration")]
            ...
            modelBuilder.Entity("CourseLibrary.API.Entities.Author", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateOfBirth = new DateTimeOffset(new DateTime(1650, 7, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 6, 47, 0, 0)),
                            FirstName = "Berry",
                        ...
                        new
                        {
                            ...
                            DateOfBirth = new DateTimeOffset(new DateTime(1668, 5, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 6, 47, 0, 0)),
                            FirstName = "Nancy",
                        ...
                        new
                        {
                            ...
                            DateOfBirth = new DateTimeOffset(new DateTime(1701, 12, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 6, 47, 0, 0)),
                            FirstName = "Eli",
                        ...
                        new
                        {
                            ...
                            DateOfBirth = new DateTimeOffset(new DateTime(1702, 3, 6, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 6, 47, 0, 0)),
                            FirstName = "Arnold",
                        ...
                        new
                        {
                            ...
                            DateOfBirth = new DateTimeOffset(new DateTime(1690, 11, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 6, 47, 0, 0)),
                            FirstName = "Seabury",
                        ...
                        new
                        {
                            ...
                            DateOfBirth = new DateTimeOffset(new DateTime(1723, 4, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 6, 47, 0, 0)),
                        ...
                        new
                        {
                            ...
                            DateOfBirth = new DateTimeOffset(new DateTime(1721, 10, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 6, 47, 0, 0)),
                            FirstName = "Atherton",
                        ...
                        new
                        {
                            ...
                            DateOfBirth = new DateTimeOffset(new DateTime(1969, 8, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 7, 30, 0, 0)),
                            FirstName = "Huxford",
                        ...
                        new
                        {
                            ...
                            DateOfBirth = new DateTimeOffset(new DateTime(1972, 1, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 7, 30, 0, 0)),
                            FirstName = "Dwennon",
                        ...
                        new
                        {
                            ...
                            DateOfBirth = new DateTimeOffset(new DateTime(1976, 7, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 7, 30, 0, 0)),
                            FirstName = "Hagley",
                        ...
                        new
                        {
                            ...
                            DateOfBirth = new DateTimeOffset(new DateTime(1977, 2, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 7, 30, 0, 0)),
                            FirstName = "Mabel",
